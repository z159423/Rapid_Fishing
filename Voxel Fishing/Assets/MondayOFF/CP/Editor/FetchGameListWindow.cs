...
namespace MondayOFF {
    ...
    public class FetchGameListWindow : EditorWindow {
        ...
        private void OnGUI() {
            ...
            EditorGUILayout.BeginHorizontal();
            GUILayout.Label("Select", _titleStyle, _width75);
            GUILayout.Label("Name", _titleStyle, _width180);
