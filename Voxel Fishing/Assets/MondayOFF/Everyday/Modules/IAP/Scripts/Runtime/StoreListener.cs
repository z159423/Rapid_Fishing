...
namespace MondayOFF {
    internal class StoreListener : IStoreListener {
        ...
        internal static event Action onAfterPurchase = default;
        ...
        internal bool PurchaseProduct(string productID) {
            ...
            if (!isInitialized) {
                Debug.Log("[EVERYDAY] Store listener is not initialized yet. Purchase will be processed after initialization");
                onInitialized += () => PurchaseProduct(productID);
                return false;
            }
