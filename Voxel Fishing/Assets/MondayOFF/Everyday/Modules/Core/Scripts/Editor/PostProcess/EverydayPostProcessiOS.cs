...
namespace MondayOFF {
    public static class EverydayPostProcessiOS {
        ...
        private static void PrepareProject(string buildPath) {
            ...
            project.AddBuildProperty(targetMain, "ENABLE_BITCODE", "NO");
            project.AddBuildProperty(targetFramework, "ENABLE_BITCODE", "NO");
            project.SetBuildProperty(targetMain, "ENABLE_BITCODE", "NO");
