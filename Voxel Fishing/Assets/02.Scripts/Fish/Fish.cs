...
public class Fish : MonoBehaviour
{
    ...
    private CharacterJoint tempJoint;
    ...
    public virtual void Hooked(Transform hook)
    {
        ...
        // transform.position = transform.position + (new Vector3(transform.position.x, transform.position.y, 0) - new Vector3(mousePoint.position.x, mousePoint.position.y, 0)).normalized * Vector3.Distance(new Vector3(mousePoint.position.x, mousePoint.position.y), new Vector3(transform.position.x, transform.position.y, 0));
        // transform.position = transform.position + (new Vector3(mousePoint.position.x, mousePoint.position.y, 0) - new Vector3(hook.position.x, hook.position.y, 0)).normalized * Vector3.Distance(new Vector3(mousePoint.position.x, mousePoint.position.y), new Vector3(hook.position.x, hook.position.y, 0));
